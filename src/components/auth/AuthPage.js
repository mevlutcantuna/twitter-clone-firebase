...
function AuthPage() {
  ...
  return (
    <div className="flex w-full lg:flex-col-reverse lg:w-full lg:mt-20">
      <img
        alt={"twitter_picture"}
        className="w-1/2 h-screen object-cover lg:w-full lg:h-40"
      ...
      <div className="w-1/2 p-4 flex justify-center items-center lg:w-full">
        <div className="flex flex-col mb-32 h-2/3 justify-around lg:h-96 ">
          <TwitterIcon
            className="text-primary-base text-5xl"
            style={{ fontSize: "4rem" }}
          />
          <div className="text-6xl font-bold">It's what's happening...</div>
          <div className="text-3xl">Join Twitter Today.</div>
          <div className="flex flex-col">
            <span
              onClick={openSignUpModal}
              className="w-96 cursor-pointer h-12 text-white rounded-3xl font-bold bg-primary-base flex items-center justify-center mb-6"
            >
              Sign Up
            </span>
            <span
              onClick={openSignInModal}
              className="w-96 cursor-pointer h-12 rounded-3xl font-bold flex items-center justify-center border-solid border-primary-base border-2"
            >
              Sign In
            </span>
          </div>
